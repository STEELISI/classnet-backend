...
<table style="width: 100%; vertical-align: top; text-align: left; padding: 0px;">
  <tr>
    <td>
        ...
        Ph No: <br>
        <span id='rep_ph'></span><br><br>
        Email: <br>
        <span id='rep_email'></span><br><br>
    </td>
  </tr>
</table>

## <p style="text-align: center;"> **FDP Data Transfer and Use Agreement (“Agreement”)** </p>
...
12. Unless otherwise specified, this Agreement and the below listed Attachments embody the entire understanding between Provider and Recipient regarding the transfer of the Data to Recipient for the
Project:
...
<table style="width: 100%; vertical-align: top; text-align: left; padding: 0px;">
  <tr>
    <td>
        <span style="font-weight: bold">By an Authorized Official of Provider</span><br>
    ...
    <td>
        ...
        Title: <span id='rep_position'></span><br>
        Date : <span id='rep_date'></span><br>
        Contact Information for Formal Notices<br>
        Name:    <span id='rep_name'></span><br> 
        Address:  <br>
...
## <p style="text-align: center;"> **Attachment 1** </p>
## <p style="text-align: center;"> Data Transfer and Use Agreement </p>
### <p style="text-align: center;"> Project Specific Information </p>

1. Description of Data
<br>

2. Description of Project  
<span id="project_description" style="font-weight: normal">Description</span>

3. Provider Support and Data Transmission: **Electronically**
...
4. Reimbursement of Costs: **None**

## <p style="text-align: center;"> **Attachment 2** </p>
## <p style="text-align: center;"> Data Transfer and Use Agreement </p>
### <p style="text-align: center;"> Data-specific Terms and Conditions: </p>
...
## <p style="text-align: center;"> **Attachment 3** </p>
## <p style="text-align: center;"> Data Transfer and Use Agreement </p>
### <p style="text-align: center;"> Identification of Permitted Collaborators (if any): </p>
...
<br>
<span id='collaborators_data'></span> <br>
